  ...
  describe('GET /api/v1/movies', () => {
    it('should return all movies', (done) => {
      ...
      .end((err, res)=> {
        ...
        // the JSON response body should have a key-value pair of {"data": [3 movie objects]}
  ...
  describe('GET /api/v1/movies/:id', () => {
    it('should respond with a single movie', (done) => {
      ...
      .end((err, res) => {
        ...
        // the JSON response body should have a key-value pair of {"status": "success"}
        res.body.status.should.eql('success');
        // the JSON response body should have a key-value pair of {"data": 1 movie object}
        res.body.data[0].should.include.keys(
          'id', 'name', 'genre', 'rating', 'explicit'
        );
        done();
    ...
    it('should throw an error if the movie does not exist', (done) => {
      ...
      .end((err, res) => {
        ...
        // the JSON response body should have a key-value pair of {"message": "That movie does not exist."}
